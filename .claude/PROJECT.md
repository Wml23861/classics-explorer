...
新增独立维度 `herHeart`（她心即佛心）。放在「情关参究」之后，作为"回向"——先修己，再理解她。

### 10段结构（与情关参究对应）

| 段 | 名称 | 视角 | 说明 |
|----|------|------|------|
| 1 | 安处 | 她 | 她想回去却不确定能不能回去的安静角落 |
| 2 | 水镜 | 般若 | 以本品智慧为镜，照见她的内心波纹，不强迫 |
| 3 | 他眼 | 她→你 | 你在她眼中是什么样子 |
| 4 | 自湖 | 她 | 她独处时内心在经历什么（deep to root level） |
| 5 | 双岸 | 中道 | 不因亲密失去自己，不因恐惧永远逃离 |
| 6 | 一息 | 实修 | 极简身体锚定，窒息感涌上时可以悄悄做 |
| 7 | 微风(可发) | 她 | 一句可以直接发给她的温柔话 |
| 8 | 微风(默念) | 你 | 你心里为她默念的祝福 |
| 9 | 你手 | 你 | 你今天具体做什么，成为她的安全地基 |
| 10 | 雷池 | 禁行 | 你绝对不能越过的边界 |
| 11 | 归灯 | 待她 | 她回来了，如何亮着一盏不追问不审判的灯 |
